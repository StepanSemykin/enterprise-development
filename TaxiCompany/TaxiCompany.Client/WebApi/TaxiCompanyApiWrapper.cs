namespace TaxiCompany.Client.WebApi;
...
public class TaxiCompanyApiWrapper(IConfiguration configuration) : ITaxiCompanyApiWrapper
{
    ...
    //public async Task<IEnumerable<ClientDto>> GetClients() => await _host.ClientAllAsync();
    //public async Task<IEnumerable<ClientDto>> GetClients() => (IEnumerable<ClientDto>)_host.ClientAllAsync();
